...
function generateViteConfig(options) {
  const plugins = options.tailwind ? `import tailwindcss from '@tailwindcss/vite'
...
async function createReactApp() {
  ...
  console.log(source_default.blue("\u{1F680} Creating React project..."));
  ...
  import_fs_extra.default.writeFileSync("vite.config.ts", viteConfigContent);
  ...
  (0, import_child_process.execSync)(`pnpm add ${baseDeps.join(" ")}`, { stdio: "inherit" });
  (0, import_child_process.execSync)(`pnpm add -D ${devDeps.join(" ")}`, { stdio: "inherit" });
  if (projectOptions.tailwind) {
    (0, import_child_process.execSync)("pnpm tailwindcss init -p", { stdio: "inherit" });
...
module.exports = {
  ...
  plugins: [],
    ...
    `.trim();
    import_fs_extra.default.writeFileSync("tailwind.config.js", tailwindConfig);
    const cssContent = `
@import "tailwindcss";
    `.trim();
    import_fs_extra.default.writeFileSync("src/index.css", cssContent);
  }
  console.log(source_default.green("\u2705 Project setup complete!"));
  console.log(
